	...
	return [
		{
			...
			"blurb": "One path to the well. Learn to hold a single line.",
			"difficulty": 1,
			"waves": 4,
			"start_essence": 160,
			"lives": 30,
			"enemy_count_scale": 0.4,
			"enemy_hp_scale": 0.5,
		...
		},
		{
			"id": "thorns",
			"name": "Western Thorns",
			"blurb": "Two roads open. Split your watch.",
			"difficulty": 2,
			"waves": 7,
			"start_essence": 90,
		...
		},
		{
			"id": "ruins",
			"name": "Eastern Ruins",
			"blurb": "Broken stones. Paths braid in.",
			"difficulty": 3,
			"waves": 8,
			"start_essence": 80,
		...
		},
		{
			"id": "bog",
			"name": "Southern Bog",
			"blurb": "Mist and mire. Many approaches.",
			"difficulty": 3,
			"waves": 8,
			"start_essence": 75,
